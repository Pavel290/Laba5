...
Реализация главного окна прилжения. Добавление кнопок настроек: большой текст, средний текст, маленький текст. Изменение размера текста с помощью editor.putInt
