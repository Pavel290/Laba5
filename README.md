...
Реализация главного окна прилжения. Добавление кнопок настроек: большой текст, средний текст, маленький текст. Ихменение размера текста с помощью editor.putInt
